    ...
    getDefaultConfig()
    {
        ...
        return {
            ...
            buttons: [
                ...
                { id: 'avd-assign-osc1',             x: 0.01,  y: 0.97,   state: true  },
                { id: 'avd-assign-osc2',             x: 0.03,  y: 0.97,   state: false },
                { id: 'avd-assign-note-on-velocity', x: 0.05,  y: 0.97,   state: false },
                { id: 'avd-assign-modewheel',        x: 0.07,  y: 0.97,   state: false },
                { id: 'avd-assign-aftertouch',       x: 0.09,  y: 0.97,   state: false },
                { id: 'avd-env-retrig',              x: 0.11,  y: 0.97,   state: true  },
                { id: 'avd-osc1-shape-blend',        x: 0.13,  y: 0.97,   state: true  },
